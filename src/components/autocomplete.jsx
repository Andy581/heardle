...
export default function Autocomplete({ suggestions, userInput, setUserInput }) {
      ...
      suggestionsListComponent = (
        ...
        <ul class="-mt-16 h-16 max-h-screen flex flex-col-reverse items-center">
          {filteredSuggestions.map((suggestion, index) => {
            ...
            return (
              <li style={{backgroundColor: index === activeSuggestion ? '#2d4358' : '#1a2633'}} class="w-full block h-3/6 border border-y-[#999999] text-zinc-50 " key={suggestion} 
  ...
  return (
    <div class=" z-20 w-2/6 border-2 border-solid border-[#afcbdd] my-32">
      {suggestionsListComponent}
